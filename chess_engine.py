...
class game_state:
    ...
    def get_all_legal_moves(self, player: str) -> List[Tuple[Tuple[int, int], Tuple[int, int]]]:
        # _all_valid_moves = [[], []]
    ...
    def king_can_castle_left(self, player: str) -> bool:
    ...
    def king_can_castle_right(self, player: str) -> bool:
        if player is Player.PLAYER_1:
